...
global.sig = 'https://instagram.com/axvrdnsy_'
global.sgh = '-' //github
...
/*============== WATERMARK ==============*/
global.wm = '                「 CAMEL BOT 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘CAMEL BOT ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ CAMEL COT '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By AXVRDNSY_`
global.author = '                「 CAMEL BOT  あ」'
